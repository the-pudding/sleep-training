<script>
    ...
    import logo from "$components/Footer/main-logo.svg"
    import arrow from "$components/Footer/arrow.svg"
            ...
            <div class="row" style="margin-bottom:0;">
                <div class="sticker-col">
                    <div class="sticker-outline">
                        <div class="sticker">
                            <a target="_self" href="https://patreon.com/thepudding"><img src="assets/branding/donate.jpg" alt=""></a>
                        </div>
                    </div>
                    <!-- <div class="link">
